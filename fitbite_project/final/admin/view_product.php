                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered first">
                                            ...
                                            <tbody>
                                                ...
                                                $select = "SELECT product.*, category.category_name FROM product JOIN category ON product.product_category = category.category_id";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="owl-carousel owl-theme" style="width: 100px;">
                                                                ...
                                                                ?>
                                                                    <div class="item">
                                                                        <img src="../images/<?php echo $file_array[$j]; ?>" height="100px" width="100px">
                                                                    </div>
                                                                <?php
                                                                }
                                                                ?>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <h2>Copyright © 2024 Concept | All rights reserved | Dashboard by <a href="#">SDP</a></h2>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
