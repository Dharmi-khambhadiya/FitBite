        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.php">Bake With Us...</a>
            ...
            <div class="container-fluid dashboard-content">    
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            ...
                            <p style=color:black class="pageheader-text" >Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                ...
                <div class="row mx-5" >
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" >
                    	<div  class="card">
                    		<div class="card-body">
                            <img src="uploads/about2.jpg">
                    			<div class="text-secondary font-italic m-3">
                                    <p>
                                       >> The Bakery Shop was founded by a team of passionate and dedicated bakers who are committed in baking the most delicious cakes,pastries,breads,cupcakes,etc. Using only the freshest ingredients we can find, you can be sure that you are served the best quality cake you can ever have.
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                       >> Our online store is a leading online shop in Another States providing cakes and gifts deliveries within that states. We provide competitive & good prices, after sales  also provide services and on-time delivery.
                                    </p>
                                    <p>
                                        >> The Bakery Shop provides same day delivery service seven days a week, including Sunday, within Singapore to provide a high level of customer service.
                                     </p>
                                    <p>
                                        >> Our Aim Is Provide The Best Bakery Products !!
                                    </p>
                                    <p>
                                    ...
                                    <p> 
                                       [Provide By The Bakery Shop Team]
                                    </p>
                                </div>
                    		</div>
                    	</div>
